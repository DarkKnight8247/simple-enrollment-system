...
<head>
    ...
    <title>SUNN Enrolment System</title>
</head>
<body>
    <form method="POST" action="process_form.php">
        ...
        <input type="text" name="first_name" placeholder="e.g. Maria" required><br><br>

        <label>Middle Name</label><br>
        <input type="text" name="middle_name" placeholder="Optional"><br><br>

        <label>Last Name <span>*</span></label><br>
        <input type="text" name="last_name" placeholder="e.g. Santos" required><br><br>
        ...
        <label>Civil Status <span>*</span></label><br>
        ...
        <small>Format: 09XXXXXXXXX (11 digits)</small><br><br>

        <label>Complete Address <span>*</span></label><br>
        ...
        <label>Year Level <span>*</span></label><br>
        ...
        <label>Previous School / Last School Attended</label><br>
        <input type="text" name="previous_school" placeholder="e.g. Sagay National High School"><br><br>

        <label>General Weighted Average (GPA)</label><br>
        <input type="number" name="gpa" step="0.01" min="1" max="100" placeholder="e.g. 92 or 1.25"><br><br>

        <p><small>By submitting, you confirm that all information provided is accurate and truthful.</small></p><br>
